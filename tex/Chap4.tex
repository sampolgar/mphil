...
A nullifier is a public piece of data that represents a user's account or specific credential information in secrecy. Our nullifier scheme commits to the user's key in a master credential and context. The deterministic version can be used in an anonymous user list for sybil resistance, and the probabilistic version can be used in membership proofs. 
...
\subsection{Proving Knowledge of a Committed Inverse}
