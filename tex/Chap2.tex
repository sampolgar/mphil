\chapter{Improved Constructions of Anonymous Credentials from New Rerandomizable Signatures for Credential Wallets}\label{chap2}
...
% Which use‐case predicates (e.g., age‐over‐threshold, multi‐credential aggregation) should we benchmark first to demonstrate both expressiveness and efficiency?
