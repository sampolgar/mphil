...
\begin{figure}[!htb]
   ...
   \begin{tikzpicture}[
    ...
    \node[chapter] (ch2) at (0,0) {\textbf{Chapter \ref{chap2}}\\Fast and Expressive\\Anonymous Credentials};
    
    \node[chapter] (ch3) at (5,0) {\textbf{Chapter \ref{chap3}}\\Identity Binding\\Multi-Issuer\\Multi-Credential\\System};
    
    \node[chapter] (ch5) at (10,0) {\textbf{Chapter \ref{chap5}}\\Threshold-Issued,\\Sybil-Resistant\\Identity System};
    ...
    \node[benchmark] (ch6) at (5,-3.2) {\textbf{Chapter \ref{chap6}:} Open Source Anonymous Credentials Benchmark Library};
