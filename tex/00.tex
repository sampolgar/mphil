...
\begin{enumerate}
    \item section \ref{sec:multiissuermulticred} is the full construction of the multi-issuer, multi-credential anonymous credential scheme using sigma proofs as a black-box
    \item section \ref{sec:sigmaproofs} outlines the sigma proofs within the construction
    \item section \ref{sec:identitysystem} builds a private identity system from constructions in section \ref{sec:multiissuermulticred} and section \ref{sec:sigmaproofs}
