...
Introduce Anonymous Credential Schemes, speak about the additional overhead needed in anonymous authentication, speak about signatures ability to be rerandomized and why that's important. Speak about how they are compatible with pedersen commitments for blind signing, and how they're compatible with pedersen commitments for zero knowledge proof presentation. Speak about the difference between verifying the rerandomized signature and proving knowledge of the attributes in a sigma protocol.
