...
We assume the auditors maintaining the revocation cannot be corrupted.
...
\newpage
\section{Multi Issuer Multi Credential Anonymous Credentials}\label{sec:multiissuermulticred}
