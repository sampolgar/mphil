...
\begin{protocol}{PS Signature: Zero-Knowledge Proof of Knowledge of Blind Signature}{blind-sig-pok}
    ...
    \textbf{Common Input:} $(p, \G_1, \G_2, \G_T, e, g, \hat{g})$, $pk = (g, Y_1,\ldots,Y_r, \hat{g}, \hat{X}, \widehat{Y}_1,\ldots,\widehat{Y}_r)$, $\sigma' = (\sigma_1, \sigma_2)$
...
\begin{itemize}
    ...
    \item \textbf{Prover Schnorr Operations}
        \begin{itemize}
            ...
            \item Compute commitment $T$: \qquad $(\ell+2)P + (\ell+1)E_{\G_T} + \ell M_{\G_T}$
                \begin{itemize}
                    \item $e(\sigma_1',\hat{X})$ \qquad $1P$
                    \item $e(\sigma_1', \hat{g})^{\tilde{t}}$ \qquad $1P + 1E_{\G_T}$
                    \item For each $j \in [1,\ell]$: $e(\sigma_1', \widehat{Y}_j)^{\tilde{m}_j}$ \qquad $1P + 1E_{\G_T}$
                    \item Multiply all terms \qquad $\ell M_{\G_T}$
                \end{itemize}
        \end{itemize}
    ...
    \item \textbf{Verifier Operations}
        \begin{itemize}
            \item Final equation verification: \qquad $(\ell+2)P + (\ell+1)E_{\G_T} + \ell M_{\G_T}$
                \begin{itemize}
                    \item $e(\sigma_2', \hat{g})$ \qquad $1P$
                    \item $e(\sigma_1',\hat{X})$ \qquad $1P$
                    \item For each $j \in [1,\ell]$: $e(\sigma_1', \widehat{Y}_j)^{z_{m_j}}$ \qquad $1P + 1E_{\G_T}$
                    \item $e(\sigma_1', \hat{g})^{z_t}$ \qquad $1P + 1E_{\G_T}$
                    \item Final multiplications \qquad $\ell M_{\G_T}$
                \end{itemize}
        \end{itemize}
\end{itemize}
