...
\newpage
\section{Security Properties Update - trying to differentiate the single credential and multiple credential protocol}
...
\todonote{Sam to go through these again}
...
\begin{pchstack}[boxed, center, space=1em]
    \procedure[]{$\mathrm{Exp}^{\mathsf{\EUFCMA}}(\adv)$}{%
        ...
        \text{Initialize } \CRED, \MSG = \emptyset \\
