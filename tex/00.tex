...
\begin{enumerate}
    ...
    Efficient Private Revocation: Interaction with existing revocation approaches either compromise anonymity [cite] or require expensive cryptographic accumulators that limit scalability.
