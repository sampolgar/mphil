...
\usepackage{verbatim}
\usepackage{tikz}
% \usetikzlibrary{positioning,shapes,shadows,fit,calc,arrows.meta}
\usetikzlibrary{positioning,shapes,shadows,arrows,fit,calc}
\usepackage{xspace}
\usepackage{amssymb}
...
% Add this before the \chapter redefinition
% \newcounter{chapter}
...
\makeatother
% Ensure section numbering includes chapter
